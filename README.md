...
3. **Dominio**: las etiquetas `og:image`, `og:url` y `canonical` en el
   `<head>` usan `https://arepitafastfood.com/` como marcador. Cámbialo
   por tu dominio real (o la URL de GitHub Pages) para que las vistas
   previas de WhatsApp/Facebook funcionen correctamente.
